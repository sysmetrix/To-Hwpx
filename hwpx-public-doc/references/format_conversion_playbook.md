...
관련 코드: `js/pdf-parser.js` · 게이트: `qa/pdf-gate.js` (`npm run test:pdf`)
...
- 보존: 본문 글자와 문단(줄바꿈으로 잘린 문장 재결합), 추론한 제목 단계, 열이 맞는 표, 들여쓴 목록과 중첩 단계.
- 제외: **그림**, 셀 병합·중첩 표, 글꼴·글자색·굵게, 단 나눔·머리말/꼬리말, 페이지 배치.
