...
- 직전 화면: `https://sysmetrix.github.io/To-Hwpx/legacy/v4.21.2/` (커밋 `6204946ef155103617c9fc39b5e74cb30dcd183f` 고정)
- 월 가용성 목표: 99.9%
- 운영 감지 목표: 15분 이내
...
7. Vercel과 Pages 모두 새 버전이고 Pages 직전판이 v4.21.2로 고정됐는지 `node qa/production-smoke.js`로 확인.
