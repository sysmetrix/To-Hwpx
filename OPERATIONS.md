...
- 직전 화면: `https://sysmetrix.github.io/To-Hwpx/legacy/v4.21.1/` (커밋 `8d68dcf8a412fefd38a910e76a4037a27bf6669f` 고정)
- 월 가용성 목표: 99.9%
- 운영 감지 목표: 15분 이내
...
7. Vercel과 Pages 모두 새 버전이고 Pages 직전판이 v4.21.1로 고정됐는지 `node qa/production-smoke.js`로 확인.
