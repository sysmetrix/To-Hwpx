...
- 직전 화면: `https://sysmetrix.github.io/To-Hwpx/legacy/v4.21.3/` (커밋 `8de8a3832566e757600e6a92d8424b7759f9bd94` 고정)
- 월 가용성 목표: 99.9%
- 운영 감지 목표: 15분 이내
...
7. Vercel과 Pages 모두 새 버전이고 Pages 직전판이 v4.21.3으로 고정됐는지 `node qa/production-smoke.js`로 확인.
