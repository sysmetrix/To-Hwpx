...
<tr><td>2단계</td><td>2026.07~09</td><td>서식 정비</td></tr></table>`,
    ...
    {
        name: 'pdf-gov-real.pdf',
        // 실제 한글 공문서에서 무너졌던 것들을 한 장에 모았다.
        //   ⚫ 글머리 기호 목록 → 2열 표로 둔갑했다
        //   테두리만 있는 설명 상자 → 표로 둔갑해 문단이 셀에 갇혔다
        //   한 쪽의 표 두 개 → 하나의 거대한 가짜 표로 뭉쳤다
        //   양쪽 정렬 문단 → 줄바꿈 자리에서 낱말이 붙었다
        html: `<h1>공공기관 AI 활용 지침</h1>
<h2>1. 추진 배경</h2>
<p style="text-align:justify">인공지능은 우리 사회 전반으로 빠르게 확산되며 일상에 자리 잡고 있다. 산업의 생산성 향상과 새로운 서비스 창출을 이끌고 있으며, 기후 변화와 재난 등 사회적 과제를 해결하는 데에도 활용되고 있다.</p>
<p>⚫ 기관은 인공지능을 사람의 판단과 선택을 지원하는 방향으로 활용한다.</p>
<p>⚫ 기관은 인공지능의 역할 범위를 명확히 설정하고 인식한다.</p>
<p>⚫ 기관은 인공지능에 대한 과도한 의존을 경계한다.</p>
<div style="border:1px solid #333;padding:8px;margin:10px 0">
  <b>설명</b><br>이 상자는 테두리만 있고 안에 칸막이가 없다. 표가 아니라 설명 상자이므로 본문으로 흘러야 한다.
</div>
<table><tr><th>구분</th><th>내용</th></tr>
<tr><td>공급자</td><td>인공지능을 설계·개발·운영한다</td></tr>
<tr><td>이용자</td><td>산출물을 검토하고 활용한다</td></tr></table>
<p>위 표와 아래 표는 서로 다른 표다.</p>
<table><tr><th>단계</th><th>기간</th></tr>
