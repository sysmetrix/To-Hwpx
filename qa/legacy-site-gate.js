...
const LEGACY_VERSION = '4.21.4';
const LEGACY_COMMIT = 'ee5a9ef181ef47cf5fa111a1f1f87465e7bf4791';
...
const stagedLegacySw = archivedSw.replace(
    "const CACHE_PREFIX = 'to-hwpx-v';\nconst CACHE_VERSION = 'to-hwpx-v4.21.4';",
    "const CACHE_PREFIX = 'to-hwpx-legacy-v4.21.4-';\nconst CACHE_VERSION = 'to-hwpx-legacy-v4.21.4-cache';",
);
assert(stagedLegacySw !== archivedSw, '고정 커밋 서비스워커 패치가 실제 원문과 일치하지 않음');
assert(stagedLegacySw.includes("const CACHE_VERSION = 'to-hwpx-legacy-v4.21.4-cache'"), '레거시 캐시 버전 패치 실패');
