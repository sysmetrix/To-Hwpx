...
const LEGACY_VERSION = '4.21.2';
const LEGACY_COMMIT = '6204946ef155103617c9fc39b5e74cb30dcd183f';
...
const stagedLegacySw = archivedSw.replace(
    ...
    "const CACHE_PREFIX = 'to-hwpx-legacy-v4.21.2-';\nconst CACHE_VERSION = 'to-hwpx-legacy-v4.21.2-cache';",
);
assert(stagedLegacySw !== archivedSw, '고정 커밋 서비스워커 패치가 실제 원문과 일치하지 않음');
assert(stagedLegacySw.includes("const CACHE_VERSION = 'to-hwpx-legacy-v4.21.2-cache'"), '레거시 캐시 버전 패치 실패');
