...
- DOCX: 제목, 본문, 표, 굵게/기울임, 이미지 1개가 있는 문서를 만들고 이미지가 HWPX에 포함되는지 확인
...
`tests/fixtures/`의 자동 golden 입력에는 UTF-8/EUC-KR TXT, 첫 시트·수식 표시값 XLSX, 일반/IR JSON이 포함된다. `tests/make-xlsx-fixture.js`는 최소 OOXML XLSX를 재현 가능하게 생성한다.
